...
<form target="" name="yamoney_form{$pt|escape:'html':'UTF-8'}" action="https://{if !$DATA_ORG['YA_ORG_TYPE']}demo{/if}money.yandex.ru/eshop.xml" method="post">
	...
	<input type="hidden" value="{$id_cart|escape:'html':'UTF-8'}" name="label" />
	<input type="hidden" value="{$id_cart|escape:'html':'UTF-8'}" name="orderNumber" />
	...
	<input type="hidden" name="customerNumber" value="{$id_cart|escape:'html':'UTF-8'}"/>
