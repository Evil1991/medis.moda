                ...
                <tbody><tr>
                    ...
                    <td class="lineh" height="245">
                        <table style="height: 245px;" align="center" border="0"
                            ...
                            <tr>
                                <td class="h8b" align="center" valign="bottom"><p align="right">OOО
                                        "ЕДПнет"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ОКАТО 40298561000</p></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody><tr>
                                            ...
                                            <td class="h8b" align="center" valign="bottom">Ф-л «Северная столица» ЗАО «Райффайзенбанк» в г. Санкт-Петербурге</td>
                                            ...
                                            <td valign="bottom" width="60%">
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tbody><tr><!-- Кор.сч. -->
                                                        ...
                                                        <td class="line_lbt" align="center" height="10" width="5%">7</td>
                                                        <td class="line_lbt" align="center" height="10" width="5%">2</td>
                                                        <td class="line_lbtr" align="center" height="10" width="5%">3</td>
                                                    </tr>
                                                    </tbody></table>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tbody><tr>
                                            <td class="h8b" valign="bottom" width="55%">Оплата услуг доступа в
                                                Интернет по договору</td>
                                            <td width="5%">&nbsp;</td>
