				        ...
				        if ($id) {
					        ...
					        foreach ($langs as $lang) {
						         Db::getInstance()->Execute('
						         	...
						         	' . $lang['id_lang'] . ', 
						         	"BelVG ' . $i . '", 
						         	" '. addslashes('<h2>Summer</h2><div style="clear: both;"> </div><h2>Accessories</h2><p><span style="color: #ffffff;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin tristique in tortor et dignissim. </span></p><div><button class="btn btn-default" style="color: #fff;" type="button">Shop now !</button></div>') .'",
						         	"belvg", 
						         	"#",
						         	"' . basename($image) . '"
						         	)
