	...
	<div>
			<!--<div style="margin-bottom:30px; padding-left:7px;">
									<a href="{$base_dir}" title="{$shop_name|escape:'html':'UTF-8'}">
										<img class="logo img-responsive" src="http://www.belvg.net/helen/prestashop_themes/theme4/themes/fashion/modules/blockcontactinfos/footer-logo.png" alt="{$shop_name|escape:'html':'UTF-8'}"/>
									</a>
			</div>	-->
