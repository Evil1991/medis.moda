		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				<h2>
					...
					<span class="ajax_cart_product_txt_s1 {if $cart_qties < 2} unvisible{/if}">
				...
				<div class="button-container">	
					...
					<a class="btn btn-default button button-medium" id="continue_checkout"	href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
						<span>
